...
namespace AliPay.SdkPay.Util
{
    ...
    public class AlipaySignature
    {
        ...
        /// <param name="privateKeyPem">privateKeyPem</param>
        /// <param name="charset">charset</param>
        /// <param name="keyFromFile">keyFromFile</param>
        /// <param name="signType">signType</param>
        /// <returns></returns>
        ...
        /// <param name="keyFromFile">signType</param>
        /// <returns>bool</returns>
        ...
        /// RSACheckContent
        /// </summary>
        /// <param name="signContent">signContent</param>
        ...
        /// </summary>
        /// <param name="signContent">signContent</param>
        /// <param name="sign">signContent</param>
        /// <param name="publicKeyPem">publicKeyPem</param>
        /// <param name="charset">charset</param>
        /// <param name="keyFromFile">keyFromFile</param>
        /// <returns>bool</returns>
        ...
        /// <param name="cusPrivateKey">cusPrivateKey</param>
        /// <param name="isCheckSign">isCheckSign</param>
        /// <param name="isDecrypt">isDecrypt</param>
        /// <returns>string</returns>
        ...
        /// encryptAndSign
        /// </summary>
        /// <param name="bizContent">bizContent</param>
        /// <param name="alipayPublicKey">alipayPublicKey</param>
        /// <param name="cusPrivateKey">cusPrivateKey</param>
        /// <param name="charset">charset</param>
        /// <param name="isEncrypt">isEncrypt</param>
        /// <param name="isSign">isSign</param>
        /// <param name="signType">signType</param>
        /// <param name="keyFromFile">keyFromFile</param>
        /// <returns>string</returns>
